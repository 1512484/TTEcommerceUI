<template>
    <div class="category-list-component">
        ...
        <div class="flex-grow overflow-auto px-5 pt-1 mb-6">
            <table class="w-full admin-list-table category-list">
                <thead></thead>
                <tbody>
                    <tr v-for="i in 9" :key="i">
                        ...
                        <td>Product name</td>
                        <td class="text-center">08:30 am - 06/09/2022</td>
                        <td class="action-column">
                            <div class="flex-center gap-5">
                                <img src="@/assets/images/icon/edit-pen.svg" class="action-icon" />
                                <img src="@/assets/images/icon/trash.svg" class="action-icon" />
                            </div>
                        </td>
                    </tr>
                </tbody>
...
export default {
    ...
    data() {
        return {
            form: this.$form.createForm(this, { name: 'category_list_search_rule' }),
            keyword: "",
            currentPage: 1
        }
    }
